        ...
        if ($errors === false) {
            ...
            if ($connect_DB) {
                ...
                if ($existed) {
                    ...
                    $add_user_query = "INSERT INTO users (id, userName, email, password, phone, firstName, familyName, status) VALUES (NULL, '$user_name', '$email', '$password', '$phone', '$first_name', '$last_name', '$verification')";
